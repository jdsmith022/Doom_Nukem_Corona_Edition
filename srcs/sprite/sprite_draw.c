...
/*   Updated: 2020/07/19 17:16:23 by rsteigen      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	find_sprite_index(t_doom *doom, t_point *sprite_begin, t_point *sprite_end, int index_sp, double pixel.y)
{
...
void	draw_stripes(t_doom *doom, t_point *sprite_begin, t_point *sprite_end, int index_sp)
{
	...
	pixel.y = sprite_begin->y;
	while (sprite_begin->y < sprite_end->y)
	{
		find_sprite_index(doom, sprite_begin, sprite_end, index_sp, pixel.y);
		pixel.y++;
	}
}
