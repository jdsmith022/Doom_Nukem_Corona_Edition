...
static void		draw_sidedef_textures(Uint32 *pixels, t_doom *doom)
{
	...
	if (doom->game_design.sidedef[doom->game_design.cur_sd].opp_sidedef != -1)
	{
		if (doom->game_design.sidedef[doom->game_design.cur_sd].txt_1 != -1)
			put_textures(TEX_S1_X, TEX_S1_Y, doom->game_design.sidedef\
				[doom->game_design.cur_sd].txt_1, doom);
		...
		if (doom->game_design.sidedef[doom->game_design.cur_sd].txt_3 != -1)
			put_textures(TEX_S3_X, TEX_S3_Y, doom->game_design.sidedef\
				[doom->game_design.cur_sd].txt_3, doom);
