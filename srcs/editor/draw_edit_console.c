...
void	draw_sidedef_images(Uint32 *pixels, t_doom *doom)
{
	...
	if (doom->game_design.cur_sd >= doom->game_design.sector[doom->game_design.cur_sec].i_sidedefs && doom->game_design.sidedef_bar == 1)
	{
...
void	draw_object_images(Uint32 *pixels, t_doom *doom)
{
	...
	if (doom->game_design.cur_obj >= doom->game_design.sector[doom->game_design.cur_sec].i_objects && doom->game_design.object_bar == 1)
